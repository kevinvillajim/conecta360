...
function TemplateAdmin({ title, propButton, content }) {
  ...
  return (
    <>
      <div className={showMenu ? "grid grid-cols-1 md:grid-cols-6" : "flex"}>
        <div
        ...
        <div className={showMenu ? "col-span-1 md:col-span-5" : "w-screen"}>
          ...
          <div
            className={`p-[2rem] bg-[#e3e3e3] ${
              showMenu ? "h-[calc(100%-65px)]" : "h-[100%]"
            }`}
          >
